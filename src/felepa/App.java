				...
				do {
					...
					case 0:
						...
						if(valor <= 0 || valor > cc.saldo) {
							JOptionPane.showMessageDialog(null, "Digite um valor maior que 0, menor ou igual seu saldo!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
							break;
						}
						cc.Sacar(valor);
					...
					case 1:
						...
						valor = Double.parseDouble(valor1);
						if(valor <= 0) {
							JOptionPane.showMessageDialog(null, "Digite um valor maior que 0!", "Confirmação", JOptionPane.INFORMATION_MESSAGE);
							break;
						}
						cc.Depositar(valor);
						JOptionPane.showMessageDialog(null, cc.exibirSaldo(), "Confirmação", JOptionPane.INFORMATION_MESSAGE);
					...
					case 3:
						...
						valor = Double.parseDouble(valor1);
						if(valor <= 0 || valor <= cc.saldo) {
							JOptionPane.showMessageDialog(null, "Você não precisa de cheque especial, " + cc.exibirSaldo(), "Confirmação", JOptionPane.INFORMATION_MESSAGE);
							break;
						}
